...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/Amal.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio,duration: 99978509, quoted : message.data, ptt: true})
        }
